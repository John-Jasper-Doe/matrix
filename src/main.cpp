...
void print_matrix(jjd::sparse_matrix<T, DEFAULT_VALUE, MATRIX_SIZE> &matrix)
{
...
int main()
{
  ...
  jjd::sparse_matrix<int> m1{2,4,7,9};
  ...
  jjd::sparse_matrix<int> m2{{3,4,5,6,7}, {2,4,7,9}, {1,2,3,4,5}};
  ...
  jjd::sparse_matrix<int> m5 = m3 + m4;
